      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: currencyProvider.isUpdating 
                ? null 
                : () async {
                    final success = await currencyProvider.refreshExchangeRates();
                    if (context.mounted) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          ...
                          backgroundColor: success ? AppTheme.positiveAmount : AppTheme.negativeAmount,
                        ),
                      );
                    }
                  },
